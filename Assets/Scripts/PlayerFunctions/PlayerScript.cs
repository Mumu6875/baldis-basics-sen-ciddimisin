...
public class PlayerScript : MonoBehaviour
{
	...
	private void MouseMove()
	{
		...
		playerRotation.eulerAngles = playerRotation.eulerAngles + Vector3.up * CF2Input.GetAxis("Mouse X") * mouseSensitivity * Time.timeScale * flipaturn;
	...
	private void PlayerMove()
	{
		...
		if (stamina > 0f)
		{
			...
			{
				playerSpeed = runSpeed * playerSpeedMultiplier;
				sensitivity = 1f;
			...
			{
				playerSpeed = walkSpeed * playerSpeedMultiplier;
	...
	public float playerSpeedMultiplier = 1.5f; // [MOD] Multiplies all walk/run speeds by this amount.
