...
public class PlayerMovement : MonoBehaviour
{
	...
	private void Update()
	{
		running = CF2Input.GetButton("Run");
		MouseMove();
		PlayerMove();
		StaminaUpdate();
	}
	private void MouseMove()
	{
		...
		rotation.eulerAngles += new Vector3(0f, CF2Input.GetAxis("Mouse X") * mouseSensitivity * Time.deltaTime * Time.timeScale, 0f);
	...
	private void PlayerMove()
	{
		...
		Vector3 a = transform.right * CF2Input.GetAxis("Strafe");
		Vector3 b = transform.forward * CF2Input.GetAxis("Forward");
