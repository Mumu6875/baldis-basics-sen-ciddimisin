...
public class InputManager : Singleton<InputManager>
{
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < (int)InputAction.Count; i++)
        {
            ...
            switch (action)
            {
                case InputAction.MoveForward: keyDown |= CF2Input.GetAxis("Forward") > 0.2f; break;
                case InputAction.MoveBackward: keyDown |= CF2Input.GetAxis("Forward") < -0.2f; break;
                case InputAction.MoveLeft: keyDown |= CF2Input.GetAxis("Strafe") < -0.2f; break;
                case InputAction.MoveRight: keyDown |= CF2Input.GetAxis("Strafe") > 0.2f; break;
                case InputAction.Interact: keyDown |= CF2Input.GetButton("Fire1"); break;
                case InputAction.Run: keyDown |= CF2Input.GetButton("Run"); break;
                case InputAction.LookBehind: keyDown |= CF2Input.GetButton("Look Behind"); break;
                case InputAction.PauseOrCancel: keyDown |= CF2Input.GetButton("Pause"); break;
            }
